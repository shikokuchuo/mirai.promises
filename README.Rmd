...
[Daniel Falbel](https://github.com/dfalbel/) for the original version of this example and consenting to its use here, as well as providing the use case which motivated this package.

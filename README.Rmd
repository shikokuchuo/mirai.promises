...
The `MIRAI_PROMISES` environment variable may be set prior to package load to customise the frequency with which to poll for promise resolution (defaults to 0.1s).

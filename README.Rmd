...
Below, a plot function requiring a long compute is simulated in a 'shiny' app.

This app takes ~2s to start compared to the 8s that it would take if the ‘long-running’ computations were not running in parallel workers.
...
[Daniel Falbel](https://github.com/dfalbel/) for the original version of the above example and consenting to its reproduction here, as well as providing the use case which motivated this package.
